...
@Autonomous(name="Vision Blue Left")
public class BlueLeftVis extends LinearOpMode {
        ...
        CommandScheduler.getInstance().schedule(
            ...
            new SequentialCommandGroup(
                new ConditionalCommand(
                    // LEFT
                    new SequentialCommandGroup(
                        new MoveLR(drive,-42*7.5, 0.6),
                        new WaitCommand(2000),
                        new MoveFB(drive,55*4, 0.6)
                    ),
                    new ConditionalCommand(
                        // CENTER
                        new SequentialCommandGroup(
