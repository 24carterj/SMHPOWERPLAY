...
@Autonomous(name="BlueConeSmall")
public class BlueConeSmall extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        lift = new TwoLiftSubsystem(hardwareMap, 1);
        ...
        CommandScheduler.getInstance().schedule(
            new SequentialCommandGroup(
                ...
                new MoveLR(drive, -140, 1),
                new WaitCommand(1000),
                new MoveFB(drive,30,1),
                new WaitCommand(200),
                new LiftUpDist(lift, 24),
                new WaitCommand(200),
                new MoveFB(drive, 18, 0.6),//.withTimeout(2000),
                new LiftDownDist(lift, 24),
